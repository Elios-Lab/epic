...
On the privacy side, the platform stores only what it needs to identify users, manage contests, and evaluate submissions. Personal information is minimized deliberately.
