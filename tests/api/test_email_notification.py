...
async def test_unknown_event_type_is_ignored():
    ...
    from epic_core.notifications import NotificationEvent
...
def test_contest_creation_notifies_admin(
    ...
    from epic_core.notifications import ContestCreated as ContestCreatedEvent
...
def test_registration_notifies_contest_owner(
    ...
    from epic_core.notifications import ParticipantRegistered as RegisteredEvent
...
def test_invitation_acceptance_notifies_inviter(
    ...
    from epic_core.notifications import InvitationAccepted as AcceptedEvent
